...
def setupwave(buf,f,w):
    ...
    #print("before fill the buffer")
    print(nsamp)
    #fill the buffer
    for isamp in range(nsamp):
        buf[isamp]=max(0,min(255,int(256*eval(w,dup*(isamp+0.5)/nsamp))))
    #print("after the buffer end")

    #print("before clock divider")
    ...
    #print("after clock divider")
    
    #print("before startdma")
    #start DMA
    startDMA(buf,int(nsamp/4))
    #print("after startdma")
    #print("end setupwave")
